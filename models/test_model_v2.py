...
METADATA_FILE = (
    PROJECT / "data" / "processed" / "insat_ir_metadata.csv"
)

TEST_DIR = (
    PROJECT / "data" / "dataset" / "test"
)

MODEL_FILE = (
    PROJECT / "models" / "best_model_v2.pth"
)
...
for image_path in test_images:
    ...
    # Convert normalized value back to knots

    prediction = (
        normalized_prediction * RANGE
        + MIN_INTENSITY
    )
